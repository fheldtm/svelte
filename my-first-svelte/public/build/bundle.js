...
var app = (function () {
    ...
    /* src\Todo.svelte generated by Svelte v3.47.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 36, 4, 687);
    			add_location(button1, file$1, 37, 4, 732);
    			add_location(div, file$1, 34, 2, 658);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*onEdit*/ ctx[4], false, false, false),
    					listen_dev(button1, "click", /*onDelete*/ ctx[7], false, false, false)
    				];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 25, 4, 417);
    			add_location(button0, file$1, 30, 4, 546);
    			add_location(button1, file$1, 31, 4, 593);
    			add_location(div, file$1, 24, 2, 406);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*updateTodo*/ ctx[6], false, false, false),
    					listen_dev(button1, "click", /*offEdit*/ ctx[5], false, false, false)
    				];
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isEdit*/ ctx[2]) return create_if_block;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $todos,
    		...
    		$$subscribe_todos = () => ($$unsubscribe_todos(), $$unsubscribe_todos = subscribe(todos, $$value => $$invalidate(10, $todos = $$value)), todos);
    	...
    	const updateTodo = () => {
    		$$invalidate(0, todo.title = title, todo);
    		offEdit();
    	};

    	const onDelete = () => {
    		set_store_value(todos, $todos = $todos.filter(t => t.id !== todo.id), $todos);
    	};
    	...
    	$$self.$$set = $$props => {
    		if ('todos' in $$props) $$subscribe_todos($$invalidate(1, todos = $$props.todos));
    ...
    class Todo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { todos: 1, todo: 0 });
    		...
    		if (/*todos*/ ctx[1] === undefined && !('todos' in props)) {
    			console.warn("<Todo> was created without expected prop 'todos'");
    		}
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const todo_changes = {};
    			if (dirty & /*$todos*/ 2) todo_changes.todo = /*todo*/ ctx[7];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:0) {#each $todos as todo}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(input, "type", "text");
    			add_location(input, file, 23, 0, 311);
    			add_location(button, file, 28, 0, 410);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*createTodo*/ ctx[3], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [title, $todos, todos, createTodo, input_input_handler, keydown_handler];
    }
